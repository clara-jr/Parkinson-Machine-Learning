...
if os.path.exists('extract.sh'):
    ...
    for pacient_devel in range(len(index_sort)):
        ...
        test.close()
        if pacient_devel != 0:
            os.system("cp features/palabras_1_0_"+parkinson_class+".arff features/Experiment_New_Data_"+str(index_sort[pacient_devel])+"_"+version+".train.arff")
        else:
            pacient_train_inic = 1
            os.system("cp features/palabras_1_1_"+parkinson_class+".arff features/Experiment_New_Data_"+str(index_sort[pacient_devel])+"_"+version+".train.arff")
