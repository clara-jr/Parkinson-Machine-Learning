...
if os.path.exists('baseline_svm_libsvm.sh'):
    ...
    for pacient in range(len(index_sort)):
        ...
        if pacient != len(index_sort)-1:
            ...
            os.system("rm print_new_data_"+str(index_sort[pacient])+"_"+str(index_sort[pacient+1])+"_"+version+".dep")
            FEATURE = "Experiment_New_Data_"+str(index_sort[pacient])+"_"+str(index_sort[pacient+1])+"_"+version
